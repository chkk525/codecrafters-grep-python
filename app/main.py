...
def find_first_match_index(input_line: str, pattern: str, start_flag: bool = False, end_flag: bool = False) -> int:
    """
...
def match_pattern_sequence(input_line: str, pattern: str) -> bool:
    ...
    while pattern:
        ...
        if pattern[0] == '(':
            ...
            alternations_str, pattern = pattern[1:
                                                closing_index], pattern[closing_index+1:]
        ...
        if pattern[0] == '\\':
            ...
            current_pattern, pattern = pattern[:
                                               closing_index], pattern[closing_index:]
        else:
